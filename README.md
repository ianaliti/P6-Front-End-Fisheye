...
Technical Details:
Factory Method Pattern: Used to create different types of media components (images and videos) dynamically, ensuring that the code is extendable and maintainable.
Dropdown Management: The dropdown menu for sorting media is fully accessible, supporting keyboard navigation and ARIA attributes to describe its behavior.
Total Likes Management: The total number of likes is calculated dynamically and updated in real-time as users interact with the media.
